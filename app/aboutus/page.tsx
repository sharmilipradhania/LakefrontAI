...
const footerNavigation = {
  solutions: [
    { name: 'Data', href: '#' },
    { name: 'Document Summarization', href: '#' },
    { name: 'Ask Anything', href: '#' },
          ...
          <DialogPanel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-gray-900 px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-white/10">
            <div className="flex items-center justify-between">
              <a href="#" className="-m-1.5 p-1.5">
                <span className="sr-only">LakeFront AI</span>
                <img
                  alt=""
      ...
      <footer >
        <div className="mx-auto max-w-7xl px-6 pb-8 pt-32 lg:px-8 lg:pt-40">
          ...
          <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24">
            <p className="text-sm/6 text-gray-400">&copy; 2024 MAMTA LLC, Inc. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
