...
app.post("/register", (request, response) => {
  ...
  if (
    ...
    connection.query(
      "INSERT INTO `users` ( `first_name`, `last_name`, `email`,`country`, `state`, `city`,`street`, `zip_code`, `password`) VALUES (?, ?, ?,?, ?, ?,?,?,?)",
      [firstname, lastname, email, country, state, city, street, zip, password],
      function (error, results, fields) {
        if (error) {
          console.log(error);
          throw error;
  ...
  //INSERT INTO `users` ( `first_name`, `last_name`, `email`,`country`, `state`, `city`,`street`, `zip_code`, `password`) VALUES ('jitu', 'jitutest', 'mailto:test@test.com','IND', 'UK', 'Doon','stree1', '232323', 'test!12@');
