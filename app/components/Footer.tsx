...
const Footer = () => {
  return (
    <div>
      <footer>
        <div className="bg-gray-300 py-4 text-black">
          <div className="container px-4 mx-auto">
            <div className="-mx-4 flex flex-wrap justify-between">
                  ...
                  <svg version="1.1" viewBox="0 0 3368 512" xmlns="http://www.w3.org/2000/svg">
                    <g fill="none" fill-rule="evenodd">
                      <g transform="translate(0 -75)">
                        <g transform="translate(0 75)">
                          <rect width="512" height="512" rx="128" fill="#03000a"></rect>
                          <rect x="149" y="176" width="220" height="220" fill="#fff"></rect>
                          <circle cx="259" cy="156" r="40" fill="#fff"></circle>
                          <circle cx="369" cy="286" r="40" fill="#00030a"></circle>
                        </g>
              ...
              <div className="px-4 my-4 w-full sm:w-auto">
                <div>
                  <h2 className="inline-block text-2xl pb-4 mb-4 border-b-4 border-black">Company</h2>
                </div>
              ...
              <div className="px-4 my-4 w-full sm:w-auto">
                <div>
                  <h2 className="inline-block text-2xl pb-4 mb-4 border-b-4 border-black">Blog</h2>
                </div>
                <ul className="leading-8">
              ...
              <div className="px-4 my-4 w-full sm:w-auto xl:w-1/5">
                <div>
                  <h2 className="inline-block text-2xl pb-4 mb-4 border-b-4 border-black">Connect With Us</h2>
                </div>
                <a href="#" className="inline-flex items-center justify-center h-8 w-8 border border-black rounded-full mr-1 hover:text-blue-400 hover:border-blue-400">
                ...
                <a href="#" className="inline-flex items-center justify-center h-8 w-8 border border-black rounded-full hover:text-blue-400 hover:border-blue-400">
