...
<div className="min-h-screen bg-gray-100 p-3 relative">
         <div className="w-96 mx-auto scroll-snap-type:x-mandatory  overflow-x: hidden;">
         
            <div className="">
               <input className="sr-only peer" type="radio" name="carousel" id="carousel-1" checked />
             
               <div
                  className=" flex w-96 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded-lg shadow-lg transition-all duration-300 opacity-0 peer-checked:opacity-100 peer-checked:z-10 z-0">
                  <img className="rounded-t-lg w-96 h-64" src="/tiger.jpg" alt="" />
            ...
            <div className="">
               ...
               <div
                  ...
                  <img className="rounded-t-lg w-96 h-64" src="/tg.jpg" alt="" />
                  <div className="py-4 px-8">
            ...
            <div className="">
               ...
               <div
                  className="w-96 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded-lg shadow-lg transition-all duration-300 opacity-0 peer-checked:opacity-100 peer-checked:z-10 z-0">
                  <img className="rounded-t-lg w-96 h-64" src="/mobile.jpg" alt="" />
                  <div className="py-4 px-8">
                     <h1 className="hover:cursor-pointer mt-2 text-gray-900 font-bold text-2xl tracking-tight">
