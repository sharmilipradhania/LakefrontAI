          ...
          <div className="flex justify-between items-center h-full">
            ...
            <ul className="hidden md:flex box gap-x-6 text-black">
                  ...
                  <ul className="px-4 w-full sm:w-1/2 lg:w-1/4 border-gray-600 border-b sm:border-r-0 lg:border-r lg:border-b-0 pb-6 pt-6 lg:pt-3">
                    ...
                    <ul className="px-4 w-full sm:w-1/2 lg:w-1/4 border-gray-600 border-b sm:border-r-0 lg:border-r lg:border-b-0 pb-6 pt-6 lg:pt-3">
                      ...
                      <div className="flex items-center py-3">
                        ...
                        <a href="/services/dataengbi" className="text-black bold border-b-2 border-black hover:text-teal-900">Find out more...</a>
                      </div>
                    </ul>
                    <ul className="px-4 w-full sm:w-1/2 lg:w-1/4 border-gray-600 border-b sm:border-b-0 sm:border-r md:border-b-0 pb-6 pt-6 lg:pt-3">
                      ...
                      <div className="flex items-center py-3">
                        ...
                        <a href="/services/aiml" className="text-black bold border-b-2 border-black hover:text-teal-900">Find out more...</a>
                      </div>
                    </ul>
                    <ul className="px-4 w-full sm:w-1/2 lg:w-1/4 border-gray-600 pb-6 pt-6 lg:pt-3">
                      ...
                      <div className="flex items-center py-3">
                        ...
                        <a href="/services/analytics" className="text-black bold border-b-2 border-black hover:text-teal-900">Find out more...</a>
                      </div>
                    </ul>
                  </div>
                </div>
              ...
              <li className="hoverable hover:bg-gray-100 hover:text-white">
                <a href="/productDescription" className="relative block  lg:p-3 lg:text-1xl  hover:bg-gray-100 hover:text-red-900">Product</a>
