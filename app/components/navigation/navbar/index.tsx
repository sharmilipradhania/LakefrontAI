            ...
            <div className="container mx-auto w-full flex flex-wrap justify-between mx-2">
              <ul className="px-1 w-full sm:w-1/2 lg:w-1/4 border-gray-600 border-b sm:border-r lg:border-b-0 pb-6 pt-6 lg:pt-3">
                <div className="flex items-center">
                  ...
                  <h3 className="font-bold text-xl text-black text-bold mb-2">Tatooine</h3>
                </div>

                <p className="text-black text-sm">Thul klivian doldur thisspiasian calrissian. Garindan d8 aurra tund polis sola tarpals.</p>
