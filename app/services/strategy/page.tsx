  ...
  return (
    <div className="container mx-auto mt-5">
          ...
          <div className="flex flex-wrap items-center sm:-mx-3">
            <div className="w-full md:w-1/2 md:px-3">
              <div className="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
                ...
                <ul className=' ml-4 text-m font-semibold'>
      ...
      <div className=' mt-10 ml-20 mr-20 mb-10'>
        ...
        <p className="pb-6 mt-5 text-m font-semibold">We evaluate your existing IT infrastructure to identify areas for improvement and optimization. Our goal is to enhance efficiency, reduce costs, and improve performance. By recommending the right mix of technologies and platforms, we help you build a robust and scalable foundation that supports your long-term objectives.</p>
